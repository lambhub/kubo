...
func BaseBlockstoreCtor(cacheOpts blockstore.CacheOpts, nilRepo bool, cfg *config.Config) func(mctx helpers.MetricsCtx, repo repo.Repo, lc fx.Lifecycle) (bs BaseBlocks, err error) {
