...
require (
	github.com/LambdaIM/proofDP v0.0.0-20191101042640-c9748d0eb9df
...
replace (
	github.com/chenzhijie/go-web3 => github.com/lambhub/go-web3 v0.0.0-20220906062849-adf910bdc428
	github.com/ipfs/go-path => github.com/lambhub/go-path v0.3.1-0.20220906063047-7f8dc2a400db
)
